...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        isObjectAmongObjects, bindListener, getSceneAnimFrameRate, getSceneByAction,
    };
};
...
registerOnClick('sphere black', false, false, [0,1,2], function() {
  assignMat('desk legs', 'chrome.001');
}, function() {});

registerOnClick('slab 1', false, false, [0,1,2], function() {
  assignMat('drawer_top', 'wood_material.00');
}, function() {});

registerOnClick('sphere chrome', false, false, [0,1,2], function() {
  assignMat('desk legs', 'chrome');
}, function() {});

registerOnClick('slab 1', false, false, [0,1,2], function() {
  assignMat('drawer_bottom', 'wood_material.00');
}, function() {});

registerOnClick('sphere green', false, false, [0,1,2], function() {
  assignMat('desk legs', 'chrome.002');
}, function() {});

registerOnClick('slab 2', false, false, [0,1,2], function() {
  assignMat('desk', 'brown wood');
}, function() {});

registerOnClick('slab 2', false, false, [0,1,2], function() {
  assignMat('drawer_top', 'brown wood');
}, function() {});

registerOnClick('slab 1', false, false, [0,1,2], function() {
  assignMat('desk', 'wood_material.00');
}, function() {});

registerOnClick('slab 2', false, false, [0,1,2], function() {
  assignMat('drawer_bottom', 'brown wood');
}, function() {});

registerOnClick('slab 2.001', false, false, [0,1,2], function() {
  assignMat('desk', 'pink wood');
}, function() {});

registerOnClick('slab 2.001', false, false, [0,1,2], function() {
  assignMat('drawer_top', 'pink wood');
}, function() {});

registerOnClick('slab 2.001', false, false, [0,1,2], function() {
  assignMat('drawer_bottom', 'pink wood');
}, function() {});

status2 = 'closed';

registerOnClick('drawer_top', false, false, [0,1,2], function() {
  if (status2 == 'closed') {

    operateAnimation('PLAY', 'drawer_top', null, null, 'LoopOnce', 1,
            function() {
      status2 = 'open';
    }, false);
    ...
    operateAnimation('PLAY', 'drawer_top', 1, 30, 'LoopOnce', 1,
            function() {
      status2 = 'open';
    }, true);
